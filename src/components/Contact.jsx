...
export const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(validationErrors).length > 0) {
            ...
            emailjs
                .send("service_2bi36rs", "template_74apj6k", formData, "2ohYTvWlSVDOl4H2f")
                .then(() => {
            ...
            <motion.form initial={{ opacity: 0 }}
                ...
                <div className="mb-4 flex space-x-4">
                    <div className="lg:w-1/2">
                        ...
                        />
                        {errors.name && <motion.p initial={{ opacity: 0}}
                            whileInView={{ opacity: 1}}
                    ...
                    <div className="lg:w-1/2">
                        <input
                            ...
                            className="mb-8 w-full appearance-none rounded-lg border border-stone-50/30 bg-transparent px-3 py-2 text-sm focus:border-stone-400 focus:outline-none"
                        />
                        {errors.email && <motion.p  initial={{ opacity: 0}}
                ...
                <div className="mb-4">
                    <textarea
                        ...
                        rows="6"
                    ></textarea>
                    {errors.message && <motion.p  initial={{ opacity: 0}}
