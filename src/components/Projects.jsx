    ...
    return (
        <section className='pt-20' id='projects'>
            <motion.h2 initial={{ opacity: 0,y:-20 }}
                ...
                transition={{ duration: 1 }} className='mb-8 text-center text-3xl lg:text-6xl'>Projects</motion.h2>
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3'>
                {PROJECTS.map((project) => {
                    return (
                        ...
                        whileHover={{scale:1.05}} key={project.id} className='group relative overflow-hidden rounded-3xl'>
